...
In this project, we propose utilizing the dataset built for Deepmind Kinetic as a means of
...
in one of 700 categories, wheras our model will attempt to generate a sentence describing the events occuring in the video.
If the full dataset were to be used (~ 650,000) clips, there would be no time left to train the model. Additionally,
our GPU resources are limited, and so, we do not have the capability to train models that require processing thousands of
clips.
